...
% Last Modified by GUIDE v2.5 20-Dec-2020 21:33:11
...
function edit_tork_Callback(hObject, eventdata, handles)
% hObject    handle to edit_tork (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of edit_tork as text
%        str2double(get(hObject,'String')) returns contents of edit_tork as a double


% --- Executes during object creation, after setting all properties.
function edit_tork_CreateFcn(hObject, eventdata, handles)
% hObject    handle to edit_tork (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
