function varargout = guidefu(varargin)
% GUIDEFU MATLAB code for guidefu.fig
%      GUIDEFU, by itself, creates a new GUIDEFU or raises the existing
%      singleton*.
%
%      H = GUIDEFU returns the handle to a new GUIDEFU or the handle to
%      the existing singleton*.
%
%      GUIDEFU('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUIDEFU.M with the given input arguments.
%
%      GUIDEFU('Property','Value',...) creates a new GUIDEFU or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before guidefu_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to guidefu_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help guidefu

% Last Modified by GUIDE v2.5 20-Dec-2020 21:39:04

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @guidefu_OpeningFcn, ...
                   'gui_OutputFcn',  @guidefu_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before guidefu is made visible.
function guidefu_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to guidefu (see VARARGIN)

% Choose default command line output for guidefu
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes guidefu wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = guidefu_OutputFcn(hObject, eventdata, handles) 
